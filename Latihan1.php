...
#header {
  ...
  background:-webkit-gradient(linear, right top, left center, color-stop(0, #cccccc),color-stop(0.5, blue),color-stop(1, #cccccc));
  }
  #P, #L, #T, #tombol { 
       color:white;
       text-align:center;
       background:-webkit-gradient(linear, right top, right bottom, from(black), to(green));
  }
</style>
</head>
<body>
